 ...
 * @brief This file is intended to declare the Axis-Aligned Bounding Box class
 * that will be used to represent the bounding boxes of the objects in the scene
 * Reference:
